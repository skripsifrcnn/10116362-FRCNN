...
parser.add_option("-d", "--input_dir", dest="input_dir", help="Path to input working directory.", default="/input_data")
parser.add_option("-u", "--output_dir", dest="output_dir", help="Path to output working directory.", default="/output")
parser.add_option("-r", "--frame_rate", dest="frame_rate", help="Frame rate of the output video.", default=15.0)
